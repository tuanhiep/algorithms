...
public class BreathFirstSearchTest {
    ...
    public void runTest() {
        // test case default
        breathFirstSearch.test(new ArrayList());
        boolean result = (Boolean) breathFirstSearch.getResult();
        ...
        breathFirstSearch.test(parameters);
        result= (Boolean) breathFirstSearch.getResult();
        Assertions.assertThat(result).isTrue();
